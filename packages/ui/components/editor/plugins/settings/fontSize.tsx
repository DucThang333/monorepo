...
import { EditorContext } from '@/components/editor/provider/editorProvider';
...
import { FONT_SIZE, ResponisveKey } from '@/components/editor/constants/cscKey';
        ...
        <div className="grid gap-4">
          ...
          <div className="flex gap-2 pt-5">
            ...
            <Button
              className="cursor-pointer"
              onClick={() => {
                element.style.setProperty(screen.keycss, fontSize);
              }}
            >
              Apply
            </Button>
